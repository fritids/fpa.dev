						...
						<?php if (isset($item['tokens']['access']['token'])) { ?>
							<tr class="form-field">
								...
								<td><input type="text" name="snapshot-destination[directory]" id="snapshot-destination-directory" 
									...
									<p class="description"><?php _e('if directory field is blank, uploaded files from Snapshot will be stored into /Apps/WPMU DEV Snapshot on your Dropbox account. The optional directory here allow you to store the uploaded files into a sub-directories. This can be multiple levels of sub-directories. This is a global setting and will be used by all snapshot configurations using this destination. You can also defined a directory used by a specific snapshot.', SNAPSHOT_I18N_DOMAIN); ?></p>
								</td>
							</tr>
							<tr>
