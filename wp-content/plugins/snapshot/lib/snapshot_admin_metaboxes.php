				...
				<div class="inside">						
					...
					<tr class="form-field">
						...
						<td>							
							...
							<input type="text" name="snapshot-destination-directory" id="snapshot-destination-directory" value="<?php if (isset($item['destination-directory'])) { echo $item['destination-directory']; } ?>" />
